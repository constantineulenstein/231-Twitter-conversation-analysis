...
legs_current = legs_current[["name.official_full", "id.bioguide", "id.thomas", "id.govtrack"]]
...
legs_social = legs_social[["id.bioguide", "id.thomas", "id.govtrack", "social.twitter_id", "social.twitter"]]

legs = pd.merge(legs_current, legs_social, how='inner', left_on=["id.bioguide", "id.thomas", "id.govtrack"],
